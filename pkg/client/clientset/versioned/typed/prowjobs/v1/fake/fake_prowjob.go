...
func (c *FakeProwJobs) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ProwJob, err error) {
	emptyResult := &v1.ProwJob{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(prowjobsResource, c.ns, name, options), emptyResult)
...
func (c *FakeProwJobs) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ProwJobList, err error) {
	emptyResult := &v1.ProwJobList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(prowjobsResource, prowjobsKind, c.ns, opts), emptyResult)
...
func (c *FakeProwJobs) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(prowjobsResource, c.ns, opts))
...
func (c *FakeProwJobs) Create(ctx context.Context, prowJob *v1.ProwJob, opts metav1.CreateOptions) (result *v1.ProwJob, err error) {
	emptyResult := &v1.ProwJob{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(prowjobsResource, c.ns, prowJob, opts), emptyResult)
...
func (c *FakeProwJobs) Update(ctx context.Context, prowJob *v1.ProwJob, opts metav1.UpdateOptions) (result *v1.ProwJob, err error) {
	emptyResult := &v1.ProwJob{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(prowjobsResource, c.ns, prowJob, opts), emptyResult)
...
func (c *FakeProwJobs) UpdateStatus(ctx context.Context, prowJob *v1.ProwJob, opts metav1.UpdateOptions) (result *v1.ProwJob, err error) {
	emptyResult := &v1.ProwJob{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(prowjobsResource, "status", c.ns, prowJob, opts), emptyResult)
...
func (c *FakeProwJobs) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(prowjobsResource, c.ns, opts, listOpts)
...
func (c *FakeProwJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ProwJob, err error) {
	emptyResult := &v1.ProwJob{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(prowjobsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)

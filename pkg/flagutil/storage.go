...
func (o *StorageClientOptions) AddFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&o.S3CredentialsFile, "s3-credentials-file", "", "File where s3 credentials are stored. For the exact format see https://github.com/kubernetes-sigs/prow/blob/main/prow/io/providers/providers.go")
}

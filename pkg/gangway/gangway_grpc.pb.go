...
func (c *prowClient) CreateJobExecution(ctx context.Context, in *CreateJobExecutionRequest, opts ...grpc.CallOption) (*JobExecution, error) {
	...
	err := c.cc.Invoke(ctx, Prow_CreateJobExecution_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *prowClient) GetJobExecution(ctx context.Context, in *GetJobExecutionRequest, opts ...grpc.CallOption) (*JobExecution, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JobExecution)
	err := c.cc.Invoke(ctx, Prow_GetJobExecution_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *prowClient) ListJobExecutions(ctx context.Context, in *ListJobExecutionsRequest, opts ...grpc.CallOption) (*JobExecutions, error) {
	...
	err := c.cc.Invoke(ctx, Prow_ListJobExecutions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *prowClient) BulkJobStatusChange(ctx context.Context, in *BulkJobStatusChangeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Prow_BulkJobStatusChange_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedProwServer must be embedded to have
...
func (UnimplementedProwServer) testEmbeddedByValue()              {}
...
func RegisterProwServer(s grpc.ServiceRegistrar, srv ProwServer) {
	// If the following call pancis, it indicates UnimplementedProwServer was

	...
	var tests = []struct {
		...
		},
		{
			...
			expected: map[string]string{
				...
				"PROW_JOB_ID":   "prowjob",
				"JOB_TYPE":      "postsubmit",
				"JOB_SPEC":      `{"type":"postsubmit","job":"job-name","buildid":"0","prowjobid":"prowjob","refs":{"org":"org-name","repo":"repo-name","base_ref":"base-ref","base_sha":"base-sha","path_alias":"k8s.io/repo-name"}}`,
				"REPO_OWNER":    "org-name",
				"REPO_NAME":     "repo-name",
				"SRC_BASE":      "repo-name",
				"SRC_HOST":      "k8s.io",
		...
		},
		{
			...
			spec: JobSpec{
				...
				Refs: &prowapi.Refs{
					...
					BaseRef:  "base-ref",
					BaseSHA:  "base-sha",
					RepoLink: "https://gitlab.com/org-name/repo-name",
				},
			},
			expected: map[string]string{
				"CI":            "true",
				...
				"PROW_JOB_ID":   "prowjob",
				"JOB_TYPE":      "postsubmit",
				"JOB_SPEC":      `{"type":"postsubmit","job":"job-name","buildid":"0","prowjobid":"prowjob","refs":{"org":"org-name","repo":"repo-name","repo_link":"https://gitlab.com/org-name/repo-name","base_ref":"base-ref","base_sha":"base-sha"}}`,
				"REPO_OWNER":    "org-name",
				"REPO_NAME":     "repo-name",
				"SRC_BASE":      "org-name/repo-name",
				"SRC_HOST":      "gitlab.com",

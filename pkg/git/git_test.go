...
// This test imports "sigs.k8s.io/prow/pkg/git/localgit", which also reference
// "sigs.k8s.io/prow/pkg/git", has to be a separate package to avoid
// circular dependency(however this file implicitly referencing "sigs.k8s.io/prow/pkg/git")
package git_test

...
func TestPruneRepoDefaults(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: Repo{RepoMetadata: RepoMetadata{HasProjects: &yes}},
		},
		{
...
func TestRepoUnmarshalJSON(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			json:     `{"private": true}`,
			expected: Repo{RepoMetadata: RepoMetadata{Visibility: new(github.RepoVisibilityPrivate)}},
		},
		{
			name:     "private false translates to visibility public",
			json:     `{"private": false}`,
			expected: Repo{RepoMetadata: RepoMetadata{Visibility: new(github.RepoVisibilityPublic)}},
		},
		{
			name:     "visibility internal is accepted directly",
			json:     `{"visibility": "internal"}`,
			expected: Repo{RepoMetadata: RepoMetadata{Visibility: new(github.RepoVisibilityInternal)}},
		},
		{
		...
		},
		{
			...
			expected: Repo{RepoMetadata: RepoMetadata{Description: new("test")}},
		},
		{

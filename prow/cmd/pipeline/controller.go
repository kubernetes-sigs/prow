...
import (
	...
	prowjobscheme "sigs.k8s.io/prow/prow/client/clientset/versioned/scheme"
	prowjobinfov1 "sigs.k8s.io/prow/prow/client/informers/externalversions/prowjobs/v1"
	prowjoblisters "sigs.k8s.io/prow/prow/client/listers/prowjobs/v1"
	"sigs.k8s.io/prow/prow/config"
	"sigs.k8s.io/prow/prow/kube"
	"sigs.k8s.io/prow/prow/pjutil"
	"sigs.k8s.io/prow/prow/pod-utils/decorate"

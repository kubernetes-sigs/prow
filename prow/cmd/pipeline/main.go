...
import (
	...
	prowjobset "sigs.k8s.io/prow/client/clientset/versioned"
	prowjobinfo "sigs.k8s.io/prow/client/informers/externalversions"
	...
	pipelineset "sigs.k8s.io/prow/pipeline/clientset/versioned"
	pipelineinfo "sigs.k8s.io/prow/pipeline/informers/externalversions"
	pipelineinfov1beta1 "sigs.k8s.io/prow/pipeline/informers/externalversions/pipeline/v1beta1"
)

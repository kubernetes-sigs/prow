...
import (
	...
	pluginhelp "sigs.k8s.io/prow/prow/pluginhelp/hook"
	"sigs.k8s.io/prow/prow/plugins"
	bzplugin "sigs.k8s.io/prow/prow/plugins/bugzilla"
	"sigs.k8s.io/prow/prow/plugins/jira"
	"sigs.k8s.io/prow/prow/plugins/ownersconfig"
	"sigs.k8s.io/prow/prow/repoowners"
	"sigs.k8s.io/prow/prow/slack"

	_ "sigs.k8s.io/prow/prow/version"
)

...
import (
	...
	needsrebase "sigs.k8s.io/prow/prow/external-plugins/needs-rebase/plugin"
	...
	_ "sigs.k8s.io/prow/prow/hook/plugin-imports"
	...
	"sigs.k8s.io/prow/prow/plugins/approve"
	"sigs.k8s.io/prow/prow/plugins/blockade"
	"sigs.k8s.io/prow/prow/plugins/blunderbuss"
	"sigs.k8s.io/prow/prow/plugins/bugzilla"
	"sigs.k8s.io/prow/prow/plugins/cherrypickunapproved"
	"sigs.k8s.io/prow/prow/plugins/hold"
	labelplugin "sigs.k8s.io/prow/prow/plugins/label"
	"sigs.k8s.io/prow/prow/plugins/lgtm"
	ownerslabel "sigs.k8s.io/prow/prow/plugins/owners-label"
	"sigs.k8s.io/prow/prow/plugins/releasenote"
	"sigs.k8s.io/prow/prow/plugins/trigger"
	verifyowners "sigs.k8s.io/prow/prow/plugins/verify-owners"
	"sigs.k8s.io/prow/prow/plugins/wip"
)

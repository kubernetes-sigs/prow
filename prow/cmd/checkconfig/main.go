...
import (
	...
	needsrebase "sigs.k8s.io/prow/external-plugins/needs-rebase/plugin"
	...
	_ "sigs.k8s.io/prow/hook/plugin-imports"
	"sigs.k8s.io/prow/io"
	...
	"sigs.k8s.io/prow/plugins/approve"
	"sigs.k8s.io/prow/plugins/blockade"
	"sigs.k8s.io/prow/plugins/blunderbuss"
	"sigs.k8s.io/prow/plugins/bugzilla"
	"sigs.k8s.io/prow/plugins/cherrypickunapproved"
	"sigs.k8s.io/prow/plugins/hold"
	labelplugin "sigs.k8s.io/prow/plugins/label"
	"sigs.k8s.io/prow/plugins/lgtm"
	ownerslabel "sigs.k8s.io/prow/plugins/owners-label"
	"sigs.k8s.io/prow/plugins/releasenote"
	"sigs.k8s.io/prow/plugins/trigger"
	verifyowners "sigs.k8s.io/prow/plugins/verify-owners"
	"sigs.k8s.io/prow/plugins/wip"
)

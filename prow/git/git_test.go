...
// This test imports "sigs.k8s.io/prow/prow/git/localgit", which also reference
// "sigs.k8s.io/prow/prow/git", has to be a separate package to avoid
// circular dependency(however this file implicitly referencing "sigs.k8s.io/prow/prow/git")
package git_test
